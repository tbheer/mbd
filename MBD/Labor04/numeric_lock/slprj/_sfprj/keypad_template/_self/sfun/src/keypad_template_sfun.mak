...
MODEL     = keypad_template
TARGET      = sfun
MODULE_SRCS   = c3_keypad_template.c
MODEL_SRC  = keypad_template_sfun.c
MODEL_REG = keypad_template_sfun_registry.c
MAKEFILE    = keypad_template_sfun.mak
...
USER_INCLUDES   =  /I "C:\Users\Ikarus\Desktop\numeric_lock"
AUX_INCLUDES   = 
MLSLSF_INCLUDES = \
    ...
    /I "C:\Users\Ikarus\Desktop\numeric_lock\slprj\_sfprj\keypad_template\_self\sfun\src" 
...
OBJLIST_FILE = keypad_template_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
#--------------------------------- Rules --------------------------------------
