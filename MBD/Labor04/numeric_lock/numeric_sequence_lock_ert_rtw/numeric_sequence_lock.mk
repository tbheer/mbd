###########################################################################
## Makefile generated for Simulink model 'numeric_sequence_lock'. 
## 
## Makefile     : numeric_sequence_lock.mk
## Generated on : Tue Nov 27 15:33:57 2018
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/numeric_sequence_lock.elf
...
PRODUCT_NAME              = numeric_sequence_lock
MAKEFILE                  = numeric_sequence_lock.mk
COMPUTER                  = PCWIN64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/numeric_sequence_lock.elf
...
DEFINES_STANDARD = -DMODEL=numeric_sequence_lock -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/numeric_sequence_lock_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/numeric_sequence_lock_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/numeric_sequence_lock_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
